            ...
            <div class="row row-to-hide">
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <h3 class="product-title">Ethiopian Yirgacheffe Cup (250 ML)</h3>
                        <div class="price">3.025 TND</div>
                        <a class="btn add-cart">Add to Cart</a>
                    </div>
                </div><br />
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <h3 class="product-title">Cold Brew Tonic In a Cup (250 ML)</h3>
                        <div class="price">1.925 TND</div>
                        <a class="btn add-cart">Add to Cart</a>
                    </div>
                </div><br />
                <div class="col-md-4">
                    <div class="box">
                        ...
                        <h3 class="product-title">Caramel Cold Foam Cold Brew (250 ML)</h3>
                        <div class="price">3.025 TND</div>
                        <a class="btn add-cart">Add to Cart</a>
                    </div>
                </div>
